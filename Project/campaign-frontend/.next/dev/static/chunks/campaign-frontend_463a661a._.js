...
function Home() {
    ...
    const handleSubmit = async ()=>{
        if (editId) {
            await axios.put(`${API}/campaigns/${editId}/`, form);
            setEditId(null);
        } else {
...
_s(Home, "Y1W3c2pp79JnBUZa4QebxvLgX1s=");
_c = Home;
var _c;
...
//# sourceMappingURL=campaign-frontend_463a661a._.js.map